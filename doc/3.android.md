...
This guide shows how to build the ezApp Android APK.
And how to install the ezApp Android APK on your smartphone.

Prior to using this guide, the steps described in 2.miniApps.md, 
...
Android version is shown at: Setup -> About phone -> Software information.
Some examples:
```
                    Android   
